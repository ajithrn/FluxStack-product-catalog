	...
	<div class="fs-product-archive-layout <?php echo esc_attr( 'sidebar-' . \FSProductCatalog\Frontend::get_sidebar_position() ); ?>">
		...
		<div class="fs-product-archive-main">
			<div class="fs-product-results-bar">
				...
				<?php if ( \FSProductCatalog\Frontend::show_sorting() ) : ?>
					<div class="fs-product-sort">
						...
						<select id="fs-sort-select" class="fs-sort-select">
							<option value="menu_order" <?php selected( \FSProductCatalog\Frontend::get_default_orderby(), 'menu_order' ); ?>><?php esc_html_e( 'Default', 'fs-product-catalog' ); ?></option>
			...
			<?php if ( have_posts() ) : ?>
				...
				<div class="fs-product-load-more-wrap" data-pagination-mode="<?php echo esc_attr( \FSProductCatalog\Frontend::get_pagination_mode() ); ?>">
					<?php if ( $wp_query->max_num_pages > 1 ) : ?>
						<?php if ( 'pagination' === \FSProductCatalog\Frontend::get_pagination_mode() ) : ?>
						...
						<?php else : ?>
							<button type="button" class="fs-product-load-more" data-page="1" data-max-pages="<?php echo esc_attr( $wp_query->max_num_pages ); ?>">
								<?php echo esc_html( \FSProductCatalog\Frontend::get_load_more_text() ); ?>
							</button>
